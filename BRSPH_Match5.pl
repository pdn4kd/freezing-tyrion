...
open my $output0, ">", "0BRSPHmatchlines115cz.csv" or die "cannot open BRSPHmatch.csv: $!";
print $output0 "BSPHnyuID,RSPHnyuID\r\n";
open my $output1, ">", "0BRSPHmatchcount115cz.csv" or die "cannot open BRSPHmatchcount.csv: $!";
