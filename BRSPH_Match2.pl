...
open my $output0, ">", "BRSPHmatchlines341c.csv" or die "cannot open BRSPHmatch.csv: $!";
print $output0 "BSPHnyuID,RSPHnyuID\r\n";
open my $output1, ">", "BRSPHmatchcount341c.csv" or die "cannot open BRSPHmatchcount.csv: $!";
